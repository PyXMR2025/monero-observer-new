...
**Update 21/10/17: proposal has been moved to the funding stage (100% funded).**

**Update 22/6/21: project will not meet proposed deadlines[^6].**

**Update 23/1/28: new CCS update posted[^7].**

**Update 23/3/16: project seeking extra funding for SDK development[^8].**
...
[^6]: [/molly-im-project-will-not-meet-proposed-deadlines-lead-dev-valldrac/](/molly-im-project-will-not-meet-proposed-deadlines-lead-dev-valldrac/)
[^7]: [https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/252#note_20549](https://repo.getmonero.org/monero-project/ccs-proposals/-/merge_requests/252#note_20549){:target="_blank"}
[^8]: [/molly-seeks-additional-36k-monero-sdk-android-development/](/molly-seeks-additional-36k-monero-sdk-android-development/)
