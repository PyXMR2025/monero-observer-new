...
**Update 22/8/3: all milestones (including M2) completed[^9].**
...
[^9]: [/hinto-janaiyo-releases-monero-bash-v1.5-completes-ccs-proposal/](/hinto-janaiyo-releases-monero-bash-v1.5-completes-ccs-proposal/)
