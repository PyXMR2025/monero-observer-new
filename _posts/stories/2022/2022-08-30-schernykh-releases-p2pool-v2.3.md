...
layout: post
category: story
title: SChernykh releases P2Pool v2.3
description: "SChernykh has released P2Pool version 2.3."
tags: mining
image: 
date: 2022-08-30 20:00
---

SChernykh[^1] has released *P2Pool*[^2] version 2.3[^3] with the following bug fixes:
...
[^3]: [https://github.com/SChernykh/p2pool/releases/tag/v2.3](https://github.com/SChernykh/p2pool/releases/tag/v2.3){:target="_blank"}{:rel="nofollow"}
