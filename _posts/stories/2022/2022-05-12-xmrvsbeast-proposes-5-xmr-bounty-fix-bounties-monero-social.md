...
**Update 22/5/14: *Low_Application_7086* has created a C# implementation which improves upon the existing Monero bounties Fider bot code[^8].**

**Update 22/6/8: site is fully functional again[^9].**
...
[^9]: [/hennyh-wins-xmrvsbeast-bounty-restoring-bounties-monero-social-functionality/](/hennyh-wins-xmrvsbeast-bounty-restoring-bounties-monero-social-functionality/)
