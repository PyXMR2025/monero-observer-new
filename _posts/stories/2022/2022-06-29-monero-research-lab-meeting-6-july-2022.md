...
layout: post
category: story
title: Monero Research Lab meeting scheduled for 6 July 2022 1700 UTC
description: Monero Research Lab meeting scheduled for 6 July 2022 1700 UTC on irc/Matrix channels.
tags: [calendar, events]
meeting_name: MRL
meeting_date: 2022-07-06 (WED)
...
meeting_logs: /assets/logs/220706-mrl.log
date: 2022-06-29 21:00
last_modified_at: 2022-07-06
---

The next Monero Research Lab[^1] meeting is scheduled to take place on Wednesday, July 6th 2022 at 17:00 UTC.
...
This meeting's chairperson will be UkoeHB[^11]. To view the full discussion topic list, consult #717[^12].

Logs for the previous meeting are available on Monero Observer[^13].

---

**Update 22/7/5: agenda, chairperson and issue now available.**

**Update 22/7/5: logs for this meeting are now available[^14].**
...
[^12]: [https://github.com/monero-project/meta/issues/717](https://github.com/monero-project/meta/issues/717){:target="_blank"}{:rel="nofollow"}
[^13]: [220629-mrl.log](/assets/logs/220629-mrl.log)
[^14]: [220706-mrl.log](/assets/logs/220706-mrl.log)
