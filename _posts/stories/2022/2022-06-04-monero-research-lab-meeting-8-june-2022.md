...
layout: post
category: story
title: Monero Research Lab meeting scheduled for 8 June 2022 1700 UTC
description: Monero Research Lab meeting scheduled for 8 June 2022 1700 UTC on irc/Matrix channels.
tags: [calendar, events]
meeting_name: MRL
meeting_date: 2022-06-08 (WED)
...
meeting_summary: /meeting-log-summary-monero-research-lab-meeting-8-june-2022
---

The next Monero Research Lab[^1] meeting is scheduled to take place on Wednesday, June 8th 2022 at 17:00 UTC.
...
This meeting's chairperson will be UkoeHB[^11]. To view the full discussion topic list, consult #711[^12].

Logs for the previous meeting are available on Monero Observer[^13].

---

**Update 22/6/6: agenda, chairperson and issue now available.**

**Update 22/6/8: logs for his meeting available on Monero Observer[^14].**

**Update 22/6/10: summary for this meeting now available on Monero Observer[^15].**
...
[^12]: [https://github.com/monero-project/meta/issues/709](https://github.com/monero-project/meta/issues/709){:target="_blank"}{:rel="nofollow"}
[^10]: https://github.com/cypherstack/triptych-multisig/blob/main/main.pdf
[^11]: https://github.com/UkoeHB
[^12]: [https://github.com/monero-project/meta/issues/712](https://github.com/monero-project/meta/issues/712){:target="_blank"}{:rel="nofollow"}
[^13]: [220601-mrl.log](/assets/logs/220601-mrl.log)
[^14]: [220608-mrl.log](/assets/logs/220608-mrl.log)
[^15]: [/meeting-log-summary-monero-research-lab-meeting-8-june-2022](/meeting-log-summary-monero-research-lab-meeting-8-june-2022)
